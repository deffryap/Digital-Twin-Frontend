...
const ComponentCard = ({ component, isHighlighted }) => {
  ...
  // Standardize: use maintenanceDueInDays across UI to match Summary and Popover
  ...
  return (
    <div
      ...
      className={`
                ...
                ${
                  isHighlighted
                    ? `${statusInfo.bgColor} ring-2 ${statusInfo.ringColor}`
                    : "bg-white shadow-sm"
                }
            `}
    >
      <div className="p-6 flex-grow">
        ...
        <div className="mb-4">
          ...
          <div className="w-full bg-slate-200 rounded-full h-2.5">
            <div
              className={`${statusInfo.strongBgColor} h-2.5 rounded-full`}
